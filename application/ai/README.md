...
| :--- | :--- | :--- | :--- |
| `iic.h` | **-** | Personal Media Corporation (384_mbit_list.zip) / ※再配布について個別許諾済|(個別許諾)|
| `iic_reg.c` | **-** | Personal Media Corporation (384_mbit_list.zip) / ※再配布について個別許諾済|(個別許諾)|
| `nrf5_iic.c` | **-** | Personal Media Corporation (384_mbit_list.zip) / ※再配布について個別許諾済|(個別許諾)|
| `app_main.c` | **-** | T3 WG of TRON Forum (384_mbit_list.zip)  / ※再配布について個別許諾済|(個別許諾)|
...
| `MainRuntime_inference.c` | **-** | Sony Group Corporation / 自動生成 (NNC v3.3.9140.33008) | Apache 2.0 |
| `MainRuntime_inference.h` | **-** | Sony Group Corporation / 自動生成 (NNC v3.3.9140.33008) | Apache 2.0 |
| `MainRuntime_parameters.c` | **-** | Sony Group Corporation / 自動生成 (NNC v3.3.9140.33008) | Apache 2.0 |
| `MainRuntime_parameters.h` | **-** | Sony Group Corporation / 自動生成 (NNC v3.3.9140.33008) | Apache 2.0 |
| `pltm_fmath.c` | **Fixed** | ゆざ (@yuza-lab) | Apache 2.0 |
| `pltm_fmath.h` | **Fixed** | ゆざ (@yuza-lab) | Apache 2.0 |
| `pltm_malloc.h` | **-** | ゆざ (@yuza-lab) | Apache 2.0 |
| `pltm_stat.h` | **-** | ゆざ (@yuza-lab) | Apache 2.0 |
| `pltm_syscall.c` | **-** | ゆざ (@yuza-lab) | Apache 2.0 |
...
- **v0.93.1 (2026-08-24)**
  - pltm_fmath.c/.h: expf()とlogf()を簡易版から精度向上版に差替，log10f()追加
